...
in denene wir Daten in R vorfinden können.
...
Werkzeugen wie den Packages des `tidyverse` zu arbeiten. Daher: nicht verzwifeln,
...
auch selten verwendet, als complexe Zahlen (_complex_) vorliegen.
...
Du kannst deine eigenen Funtionen definieren:
...
# Die Namen identifizeren die Elemente und $ gibt das entsprechende Element zurück
meine_liste$zahl
meine_liste$vector
```
...
ein Graphc-Device öffnest (`png` in diesem Beispiel),
