...
options(
  ...
  width = 55, warnPartialMatchAttr = FALSE,
...
daher nur mehr Verwirrung stiften. Zudem findet sich auf Englisch die meiste Lektüre und das Googlen von Fehlermeldungen wird erheblich erleichtert, da mehr Leute im
...
- Beispieldatensätze
  - starwars: import, mutate, plot
  - UCBAdmissions: barplots
  - Diamonds: distributions, scatterplots, covariance
  - mpg: boxplot
  - flights
  - gapminder
  - Large dataset: catalytic activity of proteins
- Statistik
