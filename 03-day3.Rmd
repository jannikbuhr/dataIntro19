...
Zunächst laden wir das tidyvers,
...
und der gleiche Correlationscoeffizient,
...
- Visualisiere die Daten (mit ggplot2) als
  ...
  - BONUS: Mach die Plots hübsch! (e.g. colors, title,
    caption)
- (Nächste Woche: Gibt es einen statistisch signifikanten Unterschied zwischen den Gruppen?)
