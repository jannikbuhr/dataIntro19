...
### Pupulationsverteilung vs. Verteilung der Mittelwerte
...
die kummulative Wahrscheinlichkeitsfunktion `pnorm`.
...
ist nun die Inverse dieser Funkion, hat also die Achsen vertautscht.
...
Das 95% Konfidenz Intervall eines Sample-Mittelwerts
...
zwischen den Gruppen exisitiere,
obwohl alle Werte aus der gleichen Verteilung stammen und daher kein
Unterschied besteht.

Bei einem P-Value von $\leq$ 0.05 (= 5\ %) wird typischerweise
gesagt, dass ein "statistisch siginifakter" Unterschied besteht.
Mit diesem tpyischen Cutoff von 0.05 akzeptieren
...
Als statistische Power bezeichnen wir die Wahrscheinlichkeit eines Tests, einenen wahren Unterschied
...
in 80% der Fälle auch tasächlich als solchen zu erkennen?"
